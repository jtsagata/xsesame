...
use crate::core::{get_sessions, program_name, SesOption, SessionInfo, SessionList};

// fn get_max_len<F>(sessions: &SessionList, f: F) -> usize
...
//
//   let mut filter_sessions = SessionList::new();
//   sessions.into_iter()
